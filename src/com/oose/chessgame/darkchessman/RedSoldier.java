...
public class RedSoldier extends DarkChessMan {
	...
	public Bitmap getIcon() {
		...
		if (this.visible)
			...
			return DarkChessPictureList
					.getIcon("com.oose.chessgame.darkchessman.UnFlip");
	}
	...
	public boolean eat(int x, int y) {
		if (moveValid(x, y)
				&& ((DarkChessMan) board.getChess(x, y)).isVisible()) {
			if (this.getLevel() >= ((DarkChessMan) board.getChess(x, y))
					.getLevel()
