...
public class KEYINDEX {
	public final static String TIMELIMIT_VALUE = "tl";
	public final static String LIMITSWITCH_BOOLEAN = "LS";
	public final static String CHESSTYPE_INT = "CT";
	public final static int CHINESECHESS = 0;
	public final static int DARKCHESS = 1;
	...
	public final static int CAMERAREQUESTCODE = 1100;
	public final static int FROMFILEREQUESTCODE = 1200;
}
