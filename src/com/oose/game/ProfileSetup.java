...
public class ProfileSetup extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (pictureDataIntent.getBooleanExtra(ChessSetup.INTENT_HAS_ICON_BOOLEAN, false)) {
      playerOneNameInput.setText(pictureDataIntent.getStringExtra(ChessSetup.PLAYER1NAME_STRING));
      playerTwoNameInput.setText(pictureDataIntent.getStringExtra(ChessSetup.PLAYER2NAME_STRING));
  ...
  public void pickPicture(View view) {
    ...
    Intent intent =
        Intent.createChooser(imageFilter, getResources().getString(R.string.choosepicture));
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    switch (requestCode) {
      ...
      case ChessSetup.FROMFILEREQUESTCODE:
        ...
        try {
          pictureImage =
              BitmapFactory.decodeStream(getContentResolver().openInputStream(pictureUri));
