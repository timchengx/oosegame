...
/*
 * Chess game setting are too many options, hence so we packed these setting into this class
 */
public class SettingBundle {
  ...
  public static final Bitmap DEFAULT_PLAYERONE_BITMAP = BitmapFactory.decodeResource(
      OOSEGame.getRes(), R.drawable.ic_launcher);
